...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open('publicmanager/saude/fixtures/CBO2002_Ocupacao_original.csv', newline='', encoding="ISO-8859-1") as csvfile:
            ...
            for row in spamreader:
                ...
                lista_profissoes.append([row['CODIGO'], titulo_sem_acento_e_em_caixa_alta])
            
            lista_profissoes.sort(key=lambda profissao: profissao[1])
            
            for dado_profissao in lista_profissoes:
                try:
                    Profissao.objects.get_or_create(
                        codigo=dado_profissao[0],
                        titulo=dado_profissao[1],
                    )
                    print(dado_profissao)
